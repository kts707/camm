...
class ViTExtractor:
    ...
    def preprocess(self, image_path: Union[str, Path],
                   load_size_ratio: Union[int, Tuple[int, int]] = None) -> Tuple[torch.Tensor, Image.Image]:
        """
        ...
        load_size = int(min(pil_image.size)*load_size_ratio)
    ...
    def extract_raw_features(self, batch: torch.Tensor, layer: int = 11, facet: str = 'key',
                            include_cls: bool = False) -> torch.Tensor:
        """
        extract raw features from the model
        :param batch: batch to extract descriptors for. Has shape BxCxHxW.
        :param layers: layer to extract. A number between 0 to 11.
        :param facet: facet to extract. One of the following options: ['key' | 'query' | 'value' | 'token']
        :return: tensor of descriptors. Bx1xtxd' where d' is the dimension of the raw features.
        """
