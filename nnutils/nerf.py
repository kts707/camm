...
class RTExpMLP(nn.Module):
    ...
    index rigid transforms from a dictionary
    """
    def __init__(self, max_t, num_freqs, t_embed_dim, data_offset, delta=False, disable_delta_rts=False):
        ...
        self.disable_delta_rts = disable_delta_rts
        if not self.disable_delta_rts:
